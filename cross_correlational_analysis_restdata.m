...
close all
%% load data
%preprocessed rest data (intro rest period)
load('D:\Dinal\OrganizedCalibrationData\FrontalRest.mat');
load('D:\Dinal\OrganizedCalibrationData\MotorRest.mat');
load('D:\Dinal\OrganizedCalibrationData\TemporalRest.mat');
...
% Gabor wavelets
fwhm = 8; %alpha = 4, beta = 8, delta = 2
cf = 21; %change center frequencies for each band. alpha = 10, beta = 21, delta = 2
